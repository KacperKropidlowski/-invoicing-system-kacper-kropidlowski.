...
class InFileDatabaseIntegrationTest extends Specification {
    ...
    def "should get all ids"() {
        ...
        inFileDatabase.save(updatedInvoice)
        then:
        (inFileDatabase.getAllInvoices()).toString().contains("[Invoice(id=1, date=2022-06-29, seller=Company(name=Relax Kebab, taxIdentificationNumber=5212205778, address=aleja Jana Pawla II 40A, 05-250 Radzymin), buyer=Company(name=AGENCJA MIENIA WOJSKOWEGO, taxIdentificationNumber=5261038122, address=ul. Nowowiejska 26A, 00-911 Warszawa), invoiceEntries=[InvoiceEntry(description=Stumetrowy kebab, price=700, vatValue=161, vatRate=Vat.VAT_23)]), Invoice(id=2, date=2022-06-29, seller=Company(name=AGENCJA MIENIA WOJSKOWEGO, taxIdentificationNumber=5261038122, address=ul. Nowowiejska 26A, 00-911 Warszawa), buyer=Company(name=Relax Kebab, taxIdentificationNumber=5212205778, address=aleja Jana Pawla II 40A, 05-250 Radzymin), invoiceEntries=[InvoiceEntry(description=Stumetrowy kebab, price=700, vatValue=161, vatRate=Vat.VAT_23)])]")
    }
